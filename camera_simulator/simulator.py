...
def send_clip_to_backend(video_path):
    ...
    print(f"📡 Sending clip '{video_path}' to the backend server...")
    try:
        with open(video_path, 'rb') as f:
            ...
            if response.status_code == 200:
                ...
                # Here you would listen for a command back from the server if needed
        ...
        print(f"   Ensure 'backend_server.py' is running. Details: {e}")
        ...
        if os.path.exists(video_path):
            ...
            print(f"🗑️ Temporary clip '{video_path}' removed.")
